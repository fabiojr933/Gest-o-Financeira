    ...
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-footer clearfix">
          <a href="<?php echo URL_BASE ?>receber/aberta" class="btn btn-primary btn-sm float-right"><i class="fas fa-arrow-left"></i> Voltar</a>
        </div>
        ...
        <div class="invoice p-3 mb-3">
          ...
          <!-- info row -->
          <form action="<?php echo URL_BASE ?>receber/pagamento" method="post">
